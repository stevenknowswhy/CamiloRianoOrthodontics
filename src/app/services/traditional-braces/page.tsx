    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-background">
      <div className="max-w-2xl w-full text-center py-20">
        <div className="mb-8 flex justify-center">
          <Image
            src="/images/services/traditional-braces.png"
        ...
        <h1 className="headline-section mb-6">Traditional Braces</h1>
        <p className="text-xl text-muted-foreground mb-8 max-w-lg mx-auto">
          We are preparing detailed information about traditional metal braces.
