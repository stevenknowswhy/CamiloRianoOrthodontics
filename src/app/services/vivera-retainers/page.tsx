...
export default function ViveraRetainersPage() {
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-background">
      <div className="max-w-2xl w-full text-center py-20">
        ...
        <h1 className="headline-section mb-6">Vivera Retainers</h1>
        <p className="text-xl text-muted-foreground mb-8 max-w-lg mx-auto">
          We are preparing detailed information about Vivera retainers.
          In the meantime, please contact us to learn more about this retention option.
        </p>
